...
- **`aquasec.exceptions`**: `AquaError` base class with `AuthenticationError` (`.status_code`, `.response_text`), `MissingCredentialsError` and `ApiError`. All exported from the package root
